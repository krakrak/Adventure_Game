 ...
 * @author Irakiza Krak
 */
public abstract class AbstractNpcKillable3 implements Killable3{
    
    private String name;
    private String descr;
    private String statement;
    private String shortC;
    private int nbLives = 100;
    
    public AbstractNpcKillable3(String nname, String ndescr, String nstatement, String nshortC, int nNbLives){
        this.name = nname;
        this.descr=ndescr;
