 ...
 * @author Irakiza Krak
 */
public abstract class AbstractNpcKillable1 implements Killable1{
    
    private String name;
    private String descr;
    private String statement;
    private String shortC;
    private int nbLives = 60;
    
    public AbstractNpcKillable1(String nname, String ndescr, String nstatement, String nshortC, int nNbLives){
        this.name = nname;
        this.descr=ndescr;
