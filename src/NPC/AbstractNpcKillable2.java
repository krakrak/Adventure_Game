 ...
 * @author Irakiza Krak
 */
public abstract class AbstractNpcKillable2 implements Killable2{
    
    private String name;
    private String descr;
    private String statement;
    private String shortC;
    private int nbLives = 50;
    
    public AbstractNpcKillable2(String nname, String ndescr, String nstatement, String nshortC, int nNbLives){
        this.name = nname;
        this.descr=ndescr;
